...
app_metrics:
    resource: '@L3tumPrometheusMetricsBundle/Resources/config/routing.xml'
```
...
app_metrics:
    ...
    controller: L3tum\PrometheusMetricsBundle\Controller\MetricsController::prometheus
```
...
by the built-in class `L3tum\PrometheusMetricsBundle\Metrics`. Here, in the example we have a prefix `symfony`
...
You are free to use the code in this repository under the terms of the MIT license. LICENSE contains a copy of this license.
  ...
  [Master Link]: https://github.com/l3tum/prometheus-metrics-bundle/tree/master
  [Master image]: https://github.com/l3tum/prometheus-metrics-bundle/workflows/PHP/badge.svg?branch=master
  [Master]: https://github.com/l3tum/prometheus-metrics-bundle/actions?query=workflow%3APHP+branch%3Amaster
  [Master coverage image]: https://img.shields.io/codecov/c/github/l3tum/prometheus-metrics-bundle/master.svg

  [Develop Link]: https://github.com/l3tum/prometheus-metrics-bundle/tree/develop
  [Develop image]: https://github.com/l3tum/prometheus-metrics-bundle/workflows/PHP/badge.svg?branch=develop
  [Develop]: https://github.com/l3tum/prometheus-metrics-bundle/actions?query=workflow%3APHP+branch%3Adevelop
  [Develop coverage image]: https://img.shields.io/codecov/c/github/l3tum/prometheus-metrics-bundle/develop.svg
